...
- No payment information ever touches Shorty. The optional "price" on a request is just a number you agree on with your roommate — actually sending that money happens entirely inside Venmo, Cash App, or Apple Cash (via Messages), apps Shorty simply opens; Shorty never sees your payment details or account information.
